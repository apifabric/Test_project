...
resourcename="testproject"  # lower case, only
resourcegroup="testproject_rg"
...
# git clone https://github.com/apilogicserver/testproject.git
# cd testproject
...
az group create --name testproject_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group testproject_rg --sku S1 --is-linux
az container create --resource-group testproject_rg --name testproject --image apilogicserver/testproject:latest --dns-name-label testproject --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//testproject.westus.azurecontainer.io:5656'
