...
@Component({
  selector: 'ApplicantSkill-home',
  templateUrl: './ApplicantSkill-home.component.html',
  styleUrls: ['./ApplicantSkill-home.component.scss']
})
export class ApplicantSkillHomeComponent implements AfterViewInit {
