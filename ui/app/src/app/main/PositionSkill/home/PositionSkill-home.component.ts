...
@Component({
  selector: 'PositionSkill-home',
  templateUrl: './PositionSkill-home.component.html',
  styleUrls: ['./PositionSkill-home.component.scss']
})
export class PositionSkillHomeComponent implements AfterViewInit {
