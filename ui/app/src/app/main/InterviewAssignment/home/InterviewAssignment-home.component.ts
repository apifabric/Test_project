...
@Component({
  selector: 'InterviewAssignment-home',
  templateUrl: './InterviewAssignment-home.component.html',
  styleUrls: ['./InterviewAssignment-home.component.scss']
})
export class InterviewAssignmentHomeComponent implements AfterViewInit {
